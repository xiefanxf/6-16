...
export const STORY = [
  ...
  },
  {
    ...
    variants: {
      main: "主教学楼的走廊很长。凛数过每一只钟，也数过每次经过窗边时雨水敲玻璃的间隔，最后两件事都停在 16:16。",
      gate: "校门外的白雾没有边界。凛把书包扔出去前，悠真提醒她先记住重量；书包从身后落下时，重量一点也没变。",
      radio: "广播室里的灰尘厚得能写字。凛碰到话筒开关时，指尖沾到一层旧粉笔灰，像有人刚从黑板前离开。",
    },
  },
